...
<%
    ...
    if (editid != null) {
        String upQ = "update user set status=1 where user_id='" + editid + "'";
                    ...
                    <div class="card-body px-0 pb-2">
                        <div class="table-responsive p-0">
                            <table class="table align-items-center mb-0">
                                ...
                                <tbody>
                                    <%
                                        String Selq = "select *from user where status=0";
...
<!--                                            <a href="add_user.jsp?edid=<%=id%>" class="btn btn-sm btn-warning">Edit</a><p></p>-->
                                            <a href="del_user.jsp?remid=<%=id%>" class="btn btn-sm btn-danger">Roll Back</a>
