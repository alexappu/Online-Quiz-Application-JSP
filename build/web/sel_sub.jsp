        ...
        <div class="row">
            ...
            <div class="col-12">
                <div class="page-header min-height-300 border-radius-xl mt-4" style="background-image: url('https://images.unsplash.com/photo-1531512073830-ba890ca4eba2?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1920&q=80');">
                    <form method="post">
                    Question: <textarea id="qname" name="qname" value="Enter the Question"></textarea> <br><p></p>
...
//                                        String Selq = "select *from question a inner join subject b on a.sub_id=b.sub_id";
                                      ...
                                      String Selq = "select *from question where sub_id='"+sub+"'";
//                                        String Selq = "SELECT *FROM question a INNER JOIN answer b ON a.q_id = b.q_id where sub_id='"+sub+"'";
                                        ...
                                        while (rs.next()) {
                                            ...
                                            String name = rs.getString("que_name");
                                            String stat = rs.getString("q_status");
...
<!--                                            <a href="add_user.jsp?edid=<%=id%>" class="btn btn-sm btn-warning">Edit</a><p></p>-->
                                         ...
                                         <td>
                                            <p class="text-xs font-weight-bold mb-0" ><%=stat%></p>
                                        </td>
